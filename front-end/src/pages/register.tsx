                ...
                <main className="h-screen bg-primary">
                    ...
                    >
                        <header className="flex flex-row px-5 sm:px-10 pt-[20px] sm:pt-[30px] justify-between md:justify-center items-center">
                            ...
                            <Link href="/" className="absolute left-[30px] md:mb-[70px] text-othergreen text-[35px] active:opacity-50 transition duration-300 ease"><FaArrowLeft /></Link>
                        ...
                        <section className="flex justify-center mt-[-30px] scale-[75%] sm:mt-[80px] sm:scale-[100%] md:mt-[60px]">
                            <form className="flex flex-col w-[450px] h-[520px] bg-secondary border-tertiary border-[2px] px-12 py-6 rounded-[25px]">
                                ...
                                <fieldset className="flex flex-col group mt-[-20px]">
                                    ...
                                    <input id="email" type="email" onChange={(e) => setEmail(e.target.value)} required className="mt-1 mb-[20px] h-[50px] pl-3 text-[20px] rounded-lg border-tertiary border-[2px] bg-primary focus:outline-none focus:border-sbgreen transition duration-300 ease" />
                                </fieldset>
                                ...
                                <fieldset className="flex flex-col group">
                                    ...
                                    <input id="password" type="password" onChange={(e) => setPassword(e.target.value)} required className="mt-1 mb-[20px] h-[50px] pl-3 text-[20px] rounded-lg border-tertiary border-[2px] bg-primary focus:outline-none focus:border-sbgreen transition duration-300 ease" />
                                </fieldset>
            
                                <fieldset className="flex flex-col group">
                                    <label htmlFor="repeatPassword" className="text-[30px] text-tertiary group-focus-within:text-sbgreen transition duration-300 ease">{t('repeatPassword')}</label>
                                    <input id="repeatPassword" type="password" onChange={(e) => setRepeatPassword(e.target.value)} required className="mt-1 mb-[40px] h-[50px] pl-3 text-[20px] rounded-lg border-tertiary border-[2px] bg-primary focus:outline-none focus:border-sbgreen transition duration-300 ease" />
                                </fieldset>
            
                                <button type="submit" onClick={handleRegister} className="mt-1 h-[65px] pl-3 text-[30px] font-semibold rounded-lg bg-sbgreen bg-opacity-50 active:bg-opacity-25 transition duration-200 ease">{t('register')}</button>
                            </form>
                        </section>
                    </motion.section>
                </main>
